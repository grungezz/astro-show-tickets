...
SECRET_KEY = (
    "django-insecure-idlia&%(=pwu2h@+3!dnh1^1uala1unx#0e-068p0zu@#b!e#j"
)
...
ROOT_URLCONF = "astro_show_tickets_api.urls"
...
WSGI_APPLICATION = "astro_show_tickets_api.wsgi.application"
